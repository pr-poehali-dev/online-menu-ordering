...
const CATEGORIES = ['Все', 'Закуски', 'Морепродукты', 'Мясо', 'Десерты'];

const MENU: { id: string; name: string; desc: string; price: number; cat: string; image: string; tag?: string }[] = [
  { id: 'm1', name: 'Тартар из тунца', desc: 'Свежий тунец, авокадо, соус понзу, кунжутное масло, икра тобико', price: 2800, cat: 'Закуски', image: SEAFOOD_IMAGE, tag: 'Шеф рекомендует' },
  { id: 'm2', name: 'Фуа-гра с бриошью', desc: 'Терин из утиной печени, карамелизованный инжир, бриошь, соль флёр де сель', price: 3600, cat: 'Закуски', image: DISH_IMAGE },
  { id: 'm3', name: 'Гребешки Saint-Jacques', desc: 'Морские гребешки, крем из цветной капусты, трюфельная пена, икра', price: 3900, cat: 'Закуски', image: SEAFOOD_IMAGE, tag: 'Новинка' },
  ...
  { id: 'm6', name: 'Палтус в масле', desc: 'Атлантический палтус, соус верже, спаржа, каперсы, лимонная цедра', price: 4200, cat: 'Морепродукты', image: DISH_IMAGE },
  { id: 'm7', name: 'Говяжья вырезка с трюфелем', desc: 'Медальон из мраморной говядины, соус перигор, картофель пай', price: 5600, cat: 'Мясо', image: DISH_IMAGE },
  { id: 'm8', name: 'Утиная грудка Магре', desc: 'Грудка утки с соусом из красного вина, конфи из редиса, полента', price: 3800, cat: 'Мясо', image: DISH_IMAGE },
  { id: 'm9', name: 'Шоколадный фондан Валрона', desc: 'Горячий шоколадный корж, ванильное мороженое, хрустящий пралине', price: 980, cat: 'Десерты', image: DISH_IMAGE },
  { id: 'm10', name: 'Крем-брюле с лавандой', desc: 'Классический французский десерт с ароматом прованской лаванды', price: 780, cat: 'Десерты', image: SEAFOOD_IMAGE },
];
